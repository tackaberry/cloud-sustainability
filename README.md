...
Malware logic that executes upon certain conditions and destroys data. The program is often used for otherwise legitimate reasons. Examples include:
...
Longer passwords are better: 8 characters is a starting point.  We expect 16 characters for all company-related passwords. 
...
Do:
Use random unmemorable alphanumeric passwords (with symbols, if the site will allow them), and a password generator like the one found in Bitwarden.  This is also valuable because it will inform you if your password is found is password lists. 
